@php
  $PublishedOn='April 14, 2019';
  $vacancy=20;
  $Employment_status='Full-time';
  $Experience='2 to 3 years(s)';
  $JobLocation='Chennai';
  $Salary='$60k-$100k';
  $Gender='Any';
...
<x-job-layout>
        <section class="section-hero overlay inner-page bg-image" style="background-image: url('/images/hero_1.jpg');" id="home-section">
                ...
                <div class="col-lg-4">
                  <div class="bg-light p-3 border rounded mb-4">
                    ...
                    <ul class="list-unstyled pl-3 mb-0">
                      ...
                      <li class="mb-2"><strong class="text-black">Employment Status:</strong>{{ $Employment_status }}</li>
                      <li class="mb-2"><strong class="text-black">Experience:</strong>{{ $Experience }}</li>
                      <li class="mb-2"><strong class="text-black">Job Location:</strong>{{ $JobLocation }}</li>
                      ...
                      <li class="mb-2"><strong class="text-black">Application Deadline:</strong> {{ $Application_Deadline }}</li>
                    </ul>
                  </div>
          ...
          <x-slot:relatedortotal>Related Jobs</x-slot:relatedortotal>
</x-job-layout>
